            ...
            <div className="mx-auto max-w-7xl">
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {sectionProducts.map((product) => (
                  <a key={product.id} href={getOfferPath(product)} className="rounded-3xl border border-zinc-200 bg-zinc-50 p-4 transition hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div className="mt-4 rounded-full bg-orange-500 px-4 py-3 text-center text-sm font-bold text-white">Zobacz ofertę</div>
                  </a>
                ))}
              </div>
            </div>

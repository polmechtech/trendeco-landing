...
export default function CookieConsent() {
  ...
  return <>
    ...
    {consent !== null && <button type="button" onClick={reset} className="fixed bottom-3 right-3 z-40 rounded-full border border-zinc-300 bg-white px-3 py-2 text-[11px] font-bold text-zinc-700 shadow-md sm:bottom-5 sm:right-5" aria-label="Zmień ustawienia cookies">Ustawienia cookies</button>}
  </>;
}
